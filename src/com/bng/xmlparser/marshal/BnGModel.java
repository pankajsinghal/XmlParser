...
public class BnGModel {
	...
	@XmlElement(name = "mxCell", type = MxCellCoreEngine.class)
	private ArrayList<MxCellCoreEngine> mxCellList;
	...
	public ArrayList<MxCellCoreEngine> getMxCellList() {
		return mxCellList;
	}

	public void setMxCellList(ArrayList<MxCellCoreEngine> mxCellList) {
